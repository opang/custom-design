      ...
      <section className="pt-10" style={{backgroundColor: "whitesmoke"}}>
        <div className=" flex flex-col justify-center items-center gap-10 md:flex-row max-w-[1340px] m-auto">
          <div className=" flex flex-col justify-center p-5 basis-1/2">
            ...
            <h1 className="font-bold text-slate-700 text-[60px]  leading-[60px] mb-5">We Print What<br/> You Want!</h1>
          ...
          <div className="p-5 ">
            <Image src="/image.jpg" width={300} height={300} alt="image" className="rounded-lg shadow-lg mb-8 w-auto h-auto md:w-[350px]" priority={true} />
          </div>
        </div>
      </section>
      <DesignSec />
