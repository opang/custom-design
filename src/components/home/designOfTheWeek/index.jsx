            ...
            <section className=" bg-white mt-20 ">
                <div className="flex flex-col   justify-center gap-8 items-center mb-20 md:flex-row">
                    ...
                    <div className="text-center shadow w-[300px]  md:w-[350px] p-3">
                        <Image src="/image-01.jpg" width={300} height={250} alt="image" priority={false} loading="lazy" className="w-auto h-auto rounded md:w-[350px]"/>
                    ...
                    <div className="text-center shadow  w-[300px] md:w-[350px] p-3">
                        ...
                        <Image src="/image-03.jpg" width={320} height={250} alt="image" loading="lazy" className="w-auto h-auto md:w-[350px] rounded"/>
                    </div>
                    <div className="text-center shadow w-[300px] md:w-[350px] p-3">
                        <Image src="/image-02.jpg" width={320} height={250} alt="image" loading="lazy" className="w-auto h-auto md:w-[350px] rounded"/>
